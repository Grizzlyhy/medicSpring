package com.zhou.code.encrypt.core;


import com.zhou.code.encrypt.algorithm.AesEncryptAlgorithm;
...
public class EncryptionFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        EncryptionRequestWrapper reqestWrapper = null;
        // 配置了需要解密才处理
        if (decryptionStatus) {
            reqestWrapper = new EncryptionRequestWrapper(req);
